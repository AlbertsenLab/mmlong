...
print OUT "Contig\tType\tStart\tEnd\tStrand\tTag\tGene\tECnumber\tProduct\n";
...
while ( my $line = <IN> ) {
	...
	print OUT "$info[0]\t$info[2]\t$info[3]\t$info[4]\t$info[6]\t$locus\t$gene\t$ec\t$product\n";
